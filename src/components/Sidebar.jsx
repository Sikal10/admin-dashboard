...
const Sidebar = () => {
    ...
    const normalLink = "flex items-center gap-5 px-4 pt-3 pb-2.5 rounded-lg text-gray-700 text-md dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2";
